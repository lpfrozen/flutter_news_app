...
import 'package:newsapp/views/SavedNewsView.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            return Icon(Icons.favorite_border,
                                color: Colors.grey); // Loading icon
                          }
                          ...
                          return IconButton(
                            ...
                            onPressed: () async {
                              if (isSaved) {
                                await viewModel
                                    .unsaveArticle(article.id); // Use id
                              } else {
                                await viewModel.saveArticle(
                                    article); // Use article directly
                              }
                            },
                          );
                        },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Navigating to the saved news view
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) =>
                  SavedNewsView(), // Replace with the view you want to navigate to
            ),
          );
        },
